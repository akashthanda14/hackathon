  ...
  return (
    <footer className="bg-black text-white py-10 px-5 md:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        {/* Logo & About Section */}
        <div>
          <img className="w-28 h-28" src="src/assets/logoai.svg" alt="" />
          <p className="text-gray-400 text-sm">
          An AI tool that quickly summarizes meetings
          </p>
        </div>
...
<li><a href="#" className="hover:text-white transition">Key Insights Extraction</a></li>
<li><a href="#" className="hover:text-white transition">Action Item Tracking</a></li>
<li><a href="#" className="hover:text-white transition">Speaker Identification</a></li>
      ...
      <div className="border-t border-gray-700 mt-10 pt-5 text-center text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} Byteforces. All Rights Reserved.
      </div>
    </footer>
  );
};
